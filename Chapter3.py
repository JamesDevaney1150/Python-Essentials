...
if c0 > 1: #take any non-negative and non-zero integer number and name it c0;
	while c0 != 1: #if c0 ≠ 1, skip to point 2
		if c0 %2 != 0:c1 = 3 * c0 + 1 #otherwise, if it's odd, evaluate a new c0 as 3 × c0 + 1
		else:c1 = c0 // 2 #f it's even, evaluate a new c0 as c0 ÷ 2
		print(c0)
		c0 = c1
		steps += 1 #step counter, counts the number of loops by incrementing 1 everyone loop
	print("steps =",steps)
else:
	print("¯\_(ツ)_/¯ Has to be above non-negative/zero")